      ...
      <div className="mx-auto max-w-5xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-sm text-foreground/70">
            See our latest bakes, behind-the-scenes, and special offers. Scan
            the QR code to follow us!
          </p>
        </div>

        <div className="mt-8 flex flex-col items-center gap-6 sm:flex-row sm:justify-center">
          <div className="rounded-2xl bg-off-white p-4 shadow-lg ring-2 ring-accent/20">
            <Image
          ...
          <div className="flex flex-col items-center gap-3 sm:items-start">
            <p className="text-sm text-foreground/70">
              Point your camera at the QR code or tap below
            </p>
            <a
